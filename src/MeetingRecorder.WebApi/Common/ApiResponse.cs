...
public class ApiResponse<T>
{
    ...
    public static ApiResponse<T> Fail(string message, int statusCode, string[]? errors = null)
...
public static class ApiResponseFactory
{
    ...
    public static ApiResponse<object?> Fail(string message, int statusCode, string[]? errors = null)
